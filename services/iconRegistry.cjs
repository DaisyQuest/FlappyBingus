...
class HighVisRedIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "hi_vis_red",
      name: "High-Vis Red",
...
class FileIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "file_icon",
      name: "File Icon",
...
class PerfectTenLinerIcon extends PlayerIconDefinition {
  constructor() {
    super({
...
class OrbFreeZigzagIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "orb_free_zigzag",
      name: "Azure Zigzag",
...
class BeeStripesIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "bee_stripes",
      name: "Bee Stripes",
...
class RainbowStripesIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "rainbow_stripes",
...
class HoneycombIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "honeycomb",
      name: "Honeycomb",
...
class MidnightHoneycombIcon extends PlayerIconDefinition {
  constructor() {
    super({
...
class LemonSliceIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "lemon_slice",
      name: "Lemon Slice",
...
class FireCapeIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "fire_cape",
      name: "Fire Cape",
...
class InfernoCapeIcon extends PlayerIconDefinition {
  constructor() {
    super({
      id: "inferno_cape",
      name: "Inferno Cape",
