...
describe("replayManager", () => {
  ...
  it("uses the realtime pacing path when requested", async () => {
    ...
    await manager.play({ captureMode: "none", paceMode: "realtime" });

    expect(playbackTicks).toHaveBeenCalledWith(expect.objectContaining({ paceMode: "realtime" }));
