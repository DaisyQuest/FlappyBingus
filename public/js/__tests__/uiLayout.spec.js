...
describe("uiLayout", () => {
  ...
  it("builds the UI shell with required screens and canvas", () => {
    ...
    expect(ui.iconOverlay?.classList.contains("modal-layer")).toBe(true);
    ...
    expect(ui.pipeTextureOverlay?.classList.contains("modal-layer")).toBe(true);
    ...
    expect(trailOverlay?.classList.contains("modal-layer")).toBe(true);
    expect(ui.iconOptions?.className).toContain("icon-grid");
    expect(ui.themeOverlay?.classList.contains("modal-layer")).toBe(true);
    expect(ui.shopOverlay?.classList.contains("hidden")).toBe(true);
    expect(ui.shopOverlay?.classList.contains("modal-layer")).toBe(true);
  ...
  it("prioritizes skills in the settings layout while compacting utilities", () => {
    ...
    const performanceCard = settingsGrid?.querySelector(".performance-card");
    expect(performanceCard?.querySelector("#highPerformanceToggle")).toBeInstanceOf(window.HTMLInputElement);
