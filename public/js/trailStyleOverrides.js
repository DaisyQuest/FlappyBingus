// =====================
// FILE: public/js/trailStyleOverrides.js
// =====================
...
export const ALLOWED_EXTRA_MODES = new Set(["trail", "sparkle", "glint", "aura"]);
...
export function normalizeTrailStyleOverrides(payload) {
  const errors = [];
